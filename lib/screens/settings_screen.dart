                  ...
                  builder: (context, shopData, child) {
                    return Column(
                      ...
                      children: [
                        ...
                        SwitchListTile(
                          title: const Text("Ambient Music", style: TextStyle(color: Colors.white)),
                        ...
                        TextButton(
                          ...
                          child: const Text("Privacy Policy", style: TextStyle(color: Colors.cyanAccent)),
                        ),
                        TextButton(
                          ...
                          child: const Text("Support", style: TextStyle(color: Colors.cyanAccent)),
                        ),
                      ],
                    );
                  },
